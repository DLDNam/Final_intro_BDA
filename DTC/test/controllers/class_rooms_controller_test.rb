...
class ClassRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_room" do
    assert_difference("ClassRoom.count") do
      post class_rooms_url, params: { class_room: { avaiable: @class_room.avaiable, name: @class_room.name, start_time: @class_room.start_time, student_number: @class_room.student_number } }
    end
  ...
  test "should update class_room" do
    patch class_room_url(@class_room), params: { class_room: { avaiable: @class_room.avaiable, name: @class_room.name, start_time: @class_room.start_time, student_number: @class_room.student_number } }
